...
Write-Host 'THQ ERP v4.8.1 local Flutter validation' -ForegroundColor Green
...
Write-Host "`nTHQ ERP v4.8.1 Flutter validation completed successfully." -ForegroundColor Green
if (-not $Build) {
