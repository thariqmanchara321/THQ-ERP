class PriceResolution {
  ...
  factory PriceResolution.fromMap(Map<String, dynamic> map) {
    ...
    return PriceResolution(
      ...
      source: map['source']?.toString() ?? 'product_price',
...
class ProductIdentifier {
  ...
  factory ProductIdentifier.fromMap(Map<String, dynamic> map) =>
      ProductIdentifier(
        id: map['identifier_id']?.toString() ?? map['id']?.toString() ?? '',
        variantId: map['variant_id']?.toString() ?? '',
        type:
            map['identifier_type']?.toString() ??
            map['type']?.toString() ??
            'barcode',
