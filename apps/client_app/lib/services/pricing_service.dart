...
class PricingService {
  ...
  Future<List<Map<String, dynamic>>> priceRules({
    required String tenantId,
  ...
  Future<void> setCustomerPriceList({
    required String tenantId,
  ...
  Future<List<Map<String, dynamic>>> customerPrices({
    required String tenantId,
    required String customerId,
    String? variantId,
  }) async {
    final r = await _supabase.rpc(
      'customer_prices_v482',
      params: {
        'p_tenant_id': tenantId,
        'p_customer_id': customerId,
        'p_variant_id': variantId,
  ...
  Future<String> saveCustomerPrice({
    required String tenantId,
    String? ruleId,
    required String customerId,
    required String variantId,
