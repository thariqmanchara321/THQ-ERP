  ...
  Future<void> _load() async {
    ...
    try {
      ...
      setState(() {
        ...
        _baseCode =
            base?.code ??
            (units.any((u) => u.code == 'PCS') ? 'PCS' : units.first.code);
        ...
        _rows
          ..clear()
          ..addAll(
            configured.where((u) => !u.isBase).map(_UnitDraft.fromOption),
          );
      });
    } catch (error) {
          ...
          : Form(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  const Text(
                    'All stock balances are stored in this base unit. Purchase/sale units convert into it.',
                  ),
                  const SizedBox(height: 16),
                  DropdownButtonFormField<String>(
                    initialValue: _units.any((u) => u.code == _baseCode)
                        ? _baseCode
                        : null,
                    ...
                    onChanged: _saving
                        ...
                        : (value) {
                            ...
                            setState(() {
                              _baseCode = value;
                              final baseUnit = _units.firstWhere(
                                (u) => u.code == value,
                              );
                              ...
                              _rows.removeWhere(
                                (r) => _unitById(r.unitId)?.code == value,
                              );
                            });
                          },
                  ),
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      FilterChip(
                        ...
                        onSelected: _saving
                            ? null
                            : (v) => setState(() => _baseCuttingAllowed = v),
                      ),
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: Text(
                          'Additional purchase / sale units',
                          style: Theme.of(context).textTheme.titleLarge
                              ?.copyWith(fontWeight: FontWeight.bold),
                        ),
                      ),
                      OutlinedButton.icon(
                        onPressed: _saving ? null : _createCustomUnit,
                        icon: const Icon(Icons.straighten_outlined),
                        label: const Text('New Custom Unit'),
                      ),
                  ...
                  const Text(
                    'Example: base METER, add COIL with conversion 90. Selling 2 COIL deducts 180 METER.',
                  ),
                  const SizedBox(height: 16),
                  if (_rows.isEmpty)
                    const Card(
                      child: Padding(
                        ...
                        child: Text(
                          'No alternate units configured. The product uses only its base unit.',
                        ),
                      ),
                    ),
                  ..._rows.asMap().entries.map(
                    (entry) => _unitCard(entry.key, entry.value),
                  ),
                  if (_error != null) ...[
                    const SizedBox(height: 12),
                    Text(
                  ...
                  Align(
                    ...
                    child: FilledButton.icon(
                      ...
                      label: Text(
                        _saving ? 'Saving...' : 'Save Unit Configuration',
                      ),
                    ),
                  ),
                ],
          ...
          children: [
              ...
              children: [
                Expanded(
                  child: DropdownButtonFormField<String>(
                    ...
                    initialValue: candidates.any((u) => u.id == row.unitId)
                        ? row.unitId
                        : null,
                    decoration: const InputDecoration(
                      labelText: 'Unit',
                    ...
                    onChanged: _saving
                        ? null
                        : (value) =>
                              setState(() => row.unitId = value ?? row.unitId),
                  ),
                ),
                const SizedBox(width: 8),
                IconButton(
            ...
            Wrap(
              ...
              children: [
                SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      labelText: '1 ${unit?.code ?? 'Unit'} = base qty',
                      border: const OutlineInputBorder(),
                    ),
                    keyboardType: const TextInputType.numberWithOptions(
                      decimal: true,
                    ),
                    onChanged: (v) => row.factor = v,
                    validator: _positive,
                  ),
                ),
                SizedBox(
                ...
                SizedBox(
                  width: 180,
                  child: TextFormField(
                    initialValue: row.salePrice,
                    decoration: const InputDecoration(
                      labelText: 'Sale price / unit',
                      border: OutlineInputBorder(),
                    ),
                    keyboardType: const TextInputType.numberWithOptions(
                      decimal: true,
                    ),
                    onChanged: (v) => row.salePrice = v,
                  ),
                ),
                SizedBox(
                  width: 180,
                  child: TextFormField(
                    initialValue: row.purchaseCost,
                    decoration: const InputDecoration(
                      labelText: 'Purchase cost / unit',
                      border: OutlineInputBorder(),
                    ),
                    keyboardType: const TextInputType.numberWithOptions(
                      decimal: true,
                    ),
                    onChanged: (v) => row.purchaseCost = v,
                  ),
                ),
              ],
            ),
            ...
            Wrap(
              ...
              children: [
                ...
                FilterChip(
                  ...
                  onSelected: _saving
                      ? null
                      : (v) => setState(() => row.allowPurchase = v),
                ),
                FilterChip(
                ...
                FilterChip(
                  ...
                  onSelected: _saving
                      ? null
                      : (v) => setState(() => row.cuttingAllowed = v),
                ),
              ],
            ),
            if (row.cuttingAllowed) ...[
              ...
              SizedBox(
                width: 220,
                child: TextFormField(
                  initialValue: row.cuttingCharge,
                  decoration: const InputDecoration(
                    labelText: 'Optional cutting charge',
                    prefixText: '₹ ',
                    border: OutlineInputBorder(),
                  ),
                  keyboardType: const TextInputType.numberWithOptions(
                  ...
                  onChanged: (v) => row.cuttingCharge = v,
                ),
              ),
            ],
          ],
          ...
          child: Column(
            ...
            children: [
              TextFormField(
                ...
                validator: (v) =>
                    (v?.trim().isEmpty ?? true) ? 'Code is required' : null,
              ),
              TextFormField(
                controller: _name,
                decoration: const InputDecoration(
