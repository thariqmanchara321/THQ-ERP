-- THQ ERP v5.2
-- Authoritative document immutability guards.
-- Applied to flexi-erp-dev as migration:
--   20260901083012_v520_authoritative_document_immutability_guards
--
-- Scope:
--   * v5.1 documents WITHOUT a v5.2 GST snapshot retain legacy behavior.
--   * v5.2 authoritative snapshot-backed documents cannot be deleted/voided
--     through legacy paths or have tax-identity/financial fields mutated.
--   * line items of authoritative documents are immutable after posting.
